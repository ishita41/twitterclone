...
<body>
    ...
    <script>//make sure we add script after button otherwise we wont be able to apply js over here. whenever this button is clicked then it will call a fxn
        function validateSignupForm(){ //js
            ...
            $("#signup-error").html(error); // pass error over here and we got error like  error ,password is empty like that
            //$("#signup-error").show();
        ...
        $("#btn-signup").click(function(){
            ...
            if(isFormValid){
                ...
                var user={ // user will have email,password
                ...
                $.ajax({
                  type: "POST",
                  url: "/login/welcome", // we make same url for get and post request different
                  ...
                  success: function(response){
                        ...
                        if(!!response){ // if not empty
                            if(response.is_logined === true){//recommended 3 =
